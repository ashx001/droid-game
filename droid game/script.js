...
var dummy1= 0
var dummy2= 0
const dummy3 = new Image()
dummy3.src = './images/invader1.png'
dummy3.onload = () => {
        dummy1 = dummy3.width*0.05
        dummy2 = dummy3.height*0.05
}
...
function drawscoreboard(scoreboard){
    ...
    space.font = 'bold 35px sans-serif'
    space.fillText('SCOREBOARD',screenW/2-120,70)
    space.fillText("1'st    "+scoreboard[0][0],screenW/2 - 200 - 40,130)
    space.fillText("2'nd    "+scoreboard[1][0],screenW/2 - 200 - 40,130+50)
    space.fillText("3'rd    "+scoreboard[2][0],screenW/2 - 200 - 40,130+100)
    space.fillText("4'th    "+scoreboard[3][0],screenW/2 - 200 - 40,130+150)
    space.fillText("5'th    "+scoreboard[4][0],screenW/2 - 200 - 40,130+200)
    
    if (dummy3){
        space.drawImage(dummy3,
            screenW/2 + 20 -40,
            88,
            dummy1,
            dummy2
    ...
    space.fillText(" x"+scoreboard[0][1],screenW/2+70-40,130)
    space.fillText(" x"+scoreboard[1][1],screenW/2+70-40,130+50)
    space.fillText(" x"+scoreboard[2][1],screenW/2+70-40,130+100)
    space.fillText(" x"+scoreboard[3][1],screenW/2+70-40,130+150)
    space.fillText(" x"+scoreboard[4][1],screenW/2+70-40,130+200)
    space.save()
    space.translate(screenW/2+150,120);
    space.rotate( (Math.PI / 180) * (-30)); 
    space.translate(-screenW/2 -150,-120);
    space.fillStyle = 'red'
    space.fillRect(screenW/2+190-40,120-7,20,14)
    space.beginPath()
    space.arc(screenW/2+190-40,120,15,0,Math.PI*2)
    space.fillStyle = 'rgb(255,255,255)'
    space.fill()
    space.restore()
    space.save()
    space.translate(screenW/2+150,120+50);
    space.rotate( (Math.PI / 180) * (-30)); 
    space.translate(-screenW/2 -150,-120-50);
    space.fillStyle = 'red'
    space.fillRect(screenW/2+190-40,120-7+50,20,14)
    space.beginPath()
    space.arc(screenW/2+190-40,120+50,15,0,Math.PI*2)
    space.fillStyle = 'rgb(255,255,255)'
    space.fill()
    space.restore()
    space.save()
    space.translate(screenW/2+150,120+100);
    space.rotate( (Math.PI / 180) * (-30)); 
    space.translate(-screenW/2 -150,-120-100);
    space.fillStyle = 'red'
    space.fillRect(screenW/2+190-40,120-7+100,20,14)
    space.beginPath()
    space.arc(screenW/2+190-40,120+100,15,0,Math.PI*2)
    space.fillStyle = 'rgb(255,255,255)'
    space.fill()
    space.restore()
    space.save()
    space.translate(screenW/2+150,120+150);
    space.rotate( (Math.PI / 180) * (-30)); 
    space.translate(-screenW/2 -150,-120-150);
    space.fillStyle = 'red'
    space.fillRect(screenW/2+190-40,120-7+150,20,14)
    space.beginPath()
    space.arc(screenW/2+190-40,120+150,15,0,Math.PI*2)
    space.fillStyle = 'rgb(255,255,255)'
    space.fill()
    space.restore()
    space.save()
    space.translate(screenW/2+150,120+200);
    space.rotate( (Math.PI / 180) * (-30)); 
    space.translate(-screenW/2 -150,-120-200);
    space.fillStyle = 'red'
    space.fillRect(screenW/2+190-40,120-7+200,20,14)
    space.beginPath()
    space.arc(screenW/2+190-40,120+200,15,0,Math.PI*2)
    space.fillStyle = 'rgb(255,255,255)'
    space.fill()
    space.restore()
    space.fillText(" x"+scoreboard[0][2],screenW/2+220-40,130)
    space.fillText(" x"+scoreboard[1][2],screenW/2+220-40,130+50)
    space.fillText(" x"+scoreboard[2][2],screenW/2+220-40,130+100)
    space.fillText(" x"+scoreboard[3][2],screenW/2+220-40,130+150)
    space.fillText(" x"+scoreboard[4][2],screenW/2+220-40,130+200)
}
...
class player{
    ...
    draw(){
        ...
        if (pHealth<25){space.fillStyle='red'}
        else{space.fillStyle = 'green'}
...
function animate(){
    ...
    space.fillText('Score: '+score,screenW-220,screenH-30)
    space.fillStyle = 'white'
    space.font = 'bold 45px sans-serif'
    p1.draw()
    p1.move()
    ...
    if (pHealth<=0 ){
        alert("GameOver..Player health is down")
        window.reload()
    }
    if (homeHealth<=0 ){
        alert("GameOver..Home health is down")
        window.reload()
    }
    ...
    if (frame<300){
        ...
        space.fillText(' > Use W A S D to Move',screenW/2-190,140)
        space.fillText(' > Use Mouse to Aim',screenW/2-180,140+40)
        space.fillText(' > Minimum score '+minScore+' to Unlock HomeTurret',screenW/2-300,220)
        space.fillText(" > Right click to HEAL the Earth in the Expense of player's Health",screenW/2-420,260)
        space.fillText(" > Score Increases rapidly When Earth's health is 100%",screenW/2-380,300)
        space.fillText(" > GameOver when player or home Health is ZERO",screenW/2-350,340)
        space.font = 'bold 45px sans-serif'        
    }
    ...
    if (frame%700==0){
        invaderspawnTime -= 10
        if (invaderspawnTime<50){invaderspawnTime=50}
    }
